...
import TodoItem, { TodoItemState } from './Cards/TodoItem'
    ...
    <>
      ...
      <SectionContent>
        <div className={cn('flex lg:gap-12')}>
          ...
          <div className={cn('relative flex flex-1 items-center justify-center')}>
            <div className={cn('-mt-8 flex gap-4', 'md:gap-6 lg:top-8 lg:mt-0')}>
              <div>
