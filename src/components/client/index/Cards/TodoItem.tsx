...
function TodoItem({
  ...
  return (
    <div
      className={cn(
        'pointer-events-none w-full border p-6 select-none',
        'lg:w-96',
    ...
    >
      <div className={cn('flex items-center', state.includes('spacing') && ['mb-4 justify-between'])}>
        <div className='flex'>
          <div
            className={cn(
              ...
              state.includes('colors')
                ...
                : ['border-white bg-[#050914] text-white', 'dark:bg-white dark:text-black']
            )}
          >
            E
          </div>
      ...
      <div
        className={cn(
          ...
          state.includes('colors') ? ['text-slate-700', 'dark:text-slate-300'] : ['text-black', 'dark:text-white']
        )}
      >
        {title}
      </div>
      <div
        className={cn(
          ...
          state.includes('colors') ? ['text-slate-600', 'dark:text-slate-400'] : ['text-black', 'dark:text-white']
        )}
      >
        {description}
      </div>
